...
shinyUI(fluidPage(
  ...
  fluidRow(
    column(3, 
           h3("Info"),
           helpText("This is a small tool helping you to choose", 
                    "appropriate mapping parameters",
                    "for the BWA mapping algorithm. Please specify both your average read length and
    ...
    column(3, 
           numericInput("mismatch", 
                        label = h3("Probability to see a read with a certain number of mismatches."), 
